            ...
            <section className="text-gray-700 body-font border-t border-gray-200">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full">
                        ...
                        <br/>
                        <br/>
That's why we created crackDSA Job Search, a free platform that connects students with internships, jobs, and opportunities in the tech field. Our platform is easy to use and has a wide range of listings, so you're sure to find something that's a good fit for you.
<br/>
<br/>
Whether you're just starting out in your SDE journey or you're looking for a new challenge, crackDSA Job Search is the perfect resource for you. 
<br/>
<br/>
Visit today and start your journey to a successful career in data science!
