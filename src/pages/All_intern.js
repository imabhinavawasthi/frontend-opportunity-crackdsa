...
const All_intern = ({ categories }) => {
  ...
  return (<div>
    <h1 className='font-semibold md:text-[35px] text-[20px] poppins-font text-[#110a60] md:mt-[37px] mt-[25px] md:ml-[44px] ml-[22px] capitalize'>{dis}</h1>

    <div className='flex gap-10 xl:justify-around justify-center flex-row flex-wrap pt-3 px-3 sm:pt-5 sm:px-5'>
      {(internships !== "No items present") ? internships.reverse().map((data, index) => {
